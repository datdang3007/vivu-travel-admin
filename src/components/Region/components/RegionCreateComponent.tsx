...
import { useRegionCreateHook } from "src/hooks";

export const RegionCreateComponent = () => {
  const { formCreate, PageList, onSubmit } = useRegionCreateHook();
