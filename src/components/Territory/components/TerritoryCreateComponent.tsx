...
import { useTerritoryCreateHook } from "src/hooks";

export const TerritoryCreateComponent = () => {
  const { formCreate, regionOptionComponent, PageList, onSubmit } =
    useTerritoryCreateHook();
